...
(function () {
    ...
    DS.LSAdapter = DS.Adapter.extend(Ember.Evented, {
        ...
        findAll: function (store, type) {
            ...
            this.logToConsole('findAll', [type, namespace, type.typeKey]);
        ...
        loadData: function () {
            ...
            console.log('loadData1: ' + this.adapterNamespace());
            console.log('loadData2: ' + storage);
        ...
        persistData: function (type, data) {
            ...
            console.log('persistData1: ' + this.adapterNamespace());
            console.log('persistData2: ' + (JSON.stringify(localStorageData)));
