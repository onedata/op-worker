...
-export([report_execution_status_update/5, get_async_call_pools/1, trigger_job_scheduling/1,
    ...
    get_first_heartbeat_timeout/1]).
%% Test API
-export([set_first_heartbeat_timeout/2]).
...
-type options() :: #{
    ...
    first_heatbeat_timeout => time:seconds() | infinity,
...
-spec get_first_heartbeat_timeout(id()) -> time:seconds() | infinity | undefined.
get_first_heartbeat_timeout(EngineId) ->
    node_cache:get({first_heatbeat_timeout, EngineId}, undefined).
...
init_service(Id, Options) ->
    ...
    case workflow_engine_state:init(Id, SlotsLimit) of
        ok ->
            ...
            set_first_heartbeat_timeout(Id, maps:get(first_heatbeat_timeout, Options, undefined)),
...
-spec set_first_heartbeat_timeout(id(), time:seconds() | infinity | undefined) -> ok.
set_first_heartbeat_timeout(Id, Timeout) ->
    put_value_in_cache(Id, first_heatbeat_timeout, Timeout).
