...
-include("oneprovider_modules/dao/dao_cookies.hrl").
    ...
    CookieDoc = case TillArg of
                    ...
                    _ ->
                        case ExistingCookieDoc of
                            ...
                            #db_document{record = CookieInfo} = CDoc ->
...
lookup_session(SessionID) ->
    case dao_lib:apply(dao_cookies, get_cookie, [SessionID], 1) of
        {ok, #db_document{record = #session_cookie{valid_till = Till, session_memory = Props}}} ->
