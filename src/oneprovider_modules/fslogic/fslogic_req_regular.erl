...
<<<<<<< HEAD:src/veil_modules/fslogic/fslogic_req_regular.erl
    % cache all permissions
    case FileDoc#veil_document.record#file.perms of
...
>>>>>>> develop:src/oneprovider_modules/fslogic/fslogic_req_regular.erl
