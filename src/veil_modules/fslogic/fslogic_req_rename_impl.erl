...
%% ====================================================================
reconstuct_tree_for_zombie_file(SourceFilePath, #veil_document{record = #file{type = ?REG_TYPE} = File} = FileDoc) ->
...
reconstuct_tree_for_zombie_file(_SourceFilePath, #veil_document{record = #file{}}) ->
    ok.
