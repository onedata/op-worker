...
% item_list_rev -> md5 of current dir state for comparison
...
%%     wf:wire("jQuery(document).bind('keydown', function (e){if (e.which == 27) document.escape_pressed();});"),
%%     Body = [
...
%%                     case Status of
%%                         exists ->
%%                             #p{body = "<b>" ++ Filename ++ "</b> is already shared. Visit <b>Shared files</b> tab for more."};
%%                         new ->
%%                             #p{body = "<b>" ++ Filename ++ "</b> successfully shared. Visit <b>Shared files</b> tab for more."}
%%                     end,
%%                     #form{class = "control-group", body = [
...
%%             remove_selected ->
%%                 {_FB, _S, _A} =
%%                     case get_key(selected_items) of
%%                         [] -> {[], undefined, undefined};
%%                         Paths ->
...
%%                             FilesString = if
%%                                               (NumFiles =:= 1) ->
%%                                                   wf:f("~B file", [NumFiles]);
%%                                               (NumFiles > 1) ->
%%                                                   wf:f("~B files", [NumFiles]);
%%                                               true -> ""
%%                                           end,
%%                             DirsString = if
%%                                              (NumDirs =:= 1) ->
%%                                                  wf:f("~B directory and all its content", [NumDirs]);
%%                                              (NumDirs > 1) ->
%%                                                  wf:f("~B directories and all their content", [NumDirs]);
%%                                              true -> ""
%%                                          end,
%%                             Punctuation = if
