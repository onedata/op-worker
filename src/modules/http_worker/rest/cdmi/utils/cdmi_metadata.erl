...
-export([get_mimetype/1, get_encoding/1, get_completion_status/1, update_mimetype/2, update_encoding/2, update_completion_status/2, set_completion_status_according_to_partial_flag/2]).
