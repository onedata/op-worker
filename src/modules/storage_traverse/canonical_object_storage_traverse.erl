...
init_storage_specific_opts(StorageTraverse = #storage_traverse{storage_file_ctx = StorageFileCtx}, Opts) ->
    SpaceId = storage_file_ctx:get_space_id_const(StorageFileCtx),
    StorageId = storage_file_ctx:get_storage_id_const(StorageFileCtx),
    case maps:get(marker, Opts, undefined) of
        undefined ->
            StorageTraverse#storage_traverse{marker = storage_file_id:space_id(SpaceId, StorageId)};
        Marker ->
