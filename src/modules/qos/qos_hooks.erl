...
reconcile_qos(FileCtx) ->
    ...
    case file_meta_links_sync_status_cache:get(SpaceId, InodeUuid) of
        ...
        {error, {file_meta_missing, MissingUuid}} ->
            add_reconcile_file_meta_posthook(FileCtx, MissingUuid, file_meta, <<"qos_missing_file_meta">>);
        {error, {link_missing, MissingUuid, MissingName}} ->
            add_reconcile_file_meta_posthook(FileCtx, MissingUuid, {link, MissingName}, <<"qos_missing_link">>)
    end.
