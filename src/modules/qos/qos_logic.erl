...
handle_missing_file_meta(FileCtx, ?MISSING_FILE_META(MissingUuid) = MissingElementFileMeta) ->
...
add_missing_file_meta_posthook(SpaceId, ?MISSING_FILE_META(MissingUuid) = MissingElement) ->
