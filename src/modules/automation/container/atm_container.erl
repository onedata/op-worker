...
-callback init(atm_data_spec2:record(), init_args()) -> container().

-callback get_data_spec(container()) -> atm_data_spec2:record().
...
-spec init(model(), atm_data_spec2:record(), init_args()) -> container().
