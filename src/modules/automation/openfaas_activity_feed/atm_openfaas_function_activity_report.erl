...
%%% @end
%%%-------------------------------------------------------------------
-module(atm_openfaas_function_activity_report).
-author("Lukasz Opiola").
...
-type record() :: #atm_openfaas_function_activity_report{}.
-export_type([record/0]).

% currently, only one type of report is supported
-type type() :: atm_openfaas_function_pod_status_report.
-type batch() :: [atm_openfaas_function_pod_status_report:record()].
