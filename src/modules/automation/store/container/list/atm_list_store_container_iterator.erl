...
-record(atm_list_store_container_iterator, {
    backend_id :: atm_list_store_container:backend_id(),
...
get_next_batch(_AtmWorkflowExecutionCtx, BatchSize, #atm_list_store_container_iterator{} = Record) ->
    #atm_list_store_container_iterator{backend_id = BackendId, index = StartIndex} = Record,
    ...
    case {Res, Marker} of
        ...
        _ ->
            ...
            {ok, Res, Record#atm_list_store_container_iterator{index = LastIndex + 1}}
    end.
