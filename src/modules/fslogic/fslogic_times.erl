...
%%--------------------------------------------------------------------
-spec update_atime(fslogic_worker:file(), UserId :: od_user:id()) -> ok.
...
%%--------------------------------------------------------------------
-spec update_atime(fslogic_worker:file(), UserId :: od_user:id(),
...
%%--------------------------------------------------------------------
-spec update_ctime(fslogic_worker:file(), UserId :: od_user:id()) -> ok.
...
%%--------------------------------------------------------------------
-spec update_ctime(fslogic_worker:file(), UserId :: od_user:id(),
    CurrentTime :: file_meta:time()) -> ok.
...
%%--------------------------------------------------------------------
-spec update_mtime_ctime(fslogic_worker:file(), UserId :: od_user:id()) ->
    ok.
