...
%% @end
%%--------------------------------------------------------------------
-spec check_perms(user_context:ctx(), file_context:ctx(), fslogic_worker:open_flag()) ->
...
%% @end
%%--------------------------------------------------------------------
-spec check_perms_read(user_context:ctx(), file_context:ctx()) ->
    fslogic_worker:provider_response().
...
%% @end
%%--------------------------------------------------------------------
-spec check_perms_write(user_context:ctx(), file_context:ctx()) ->
    fslogic_worker:provider_response().
...
%% @end
%%--------------------------------------------------------------------
-spec check_perms_rdwr(user_context:ctx(), file_context:ctx()) ->
    fslogic_worker:provider_response().
