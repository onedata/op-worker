...
-export([
    ...
    get_active_perms_type/2, get_acl/1, get_mode/1, get_file_size/1, get_file_sizes_summary/1,
...
-spec get_file_sizes_summary(ctx() | file_meta:uuid()) -> {[{total | storage:id(), non_neg_integer()}], ctx()}.
get_file_sizes_summary(FileCtx) ->
