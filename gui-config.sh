...
PRIMARY_IMAGE='docker.onedata.org/op-gui-default:VFS-4242-add-cancel-button-for-transfers'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/op-gui-default:VFS-4242-add-cancel-button-for-transfers'
