...
PRIMARY_IMAGE='docker.onedata.org/op-gui-default:VFS-4791-many-chunks-render-18.07'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/op-gui-default:VFS-4791-many-chunks-render-18.07'
