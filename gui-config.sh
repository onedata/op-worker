...
PRIMARY_IMAGE='docker.onedata.org/op-gui-default:VFS-5038-allow-empty-handle-metadata-18.07'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/op-gui-default:VFS-5038-allow-empty-handle-metadata-18.07'
