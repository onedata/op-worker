...
PRIMARY_IMAGE='docker.onedata.org/op-gui-default:VFS-5030-index-transfers-fix-debug-18.07'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/op-gui-default:VFS-5030-index-transfers-fix-debug-18.07'
