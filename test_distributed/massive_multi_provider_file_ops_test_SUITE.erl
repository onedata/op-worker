...
db_sync_test(Config) ->
    ...
    multi_provider_file_ops_base:synchronization_test_base(Config, <<"user1">>, {3,0,0}, 150, 10, 50).
%%multi_provider_file_ops_base:synchronization_test_base(Config, <<"user1">>, {3,0,0}, 60, 10, 50).
