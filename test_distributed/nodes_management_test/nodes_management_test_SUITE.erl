...
all() -> [fuse_session_cleanup_test, main_test, callbacks_test, sub_proc_test].
...
init_per_testcase(_, Config) ->
  ...
  StartLog = nodes_manager:start_app_on_nodes(NodesUp, [
    [{node_type, ccm_test}, {dispatcher_port, 5055}, {control_panel_port, 1350}, {rest_port, 8443}, {ccm_nodes, [CCM]}, {dns_port, 1308}, {db_nodes, [DBNode]}, {fuse_session_expire_time, 2}, {dao_fuse_cache_loop_time, 1}],
    [{node_type, worker}, {dispatcher_port, 6666}, {control_panel_port, 1351}, {rest_port, 8444}, {ccm_nodes, [CCM]}, {dns_port, 1309}, {db_nodes, [DBNode]}, {fuse_session_expire_time, 2}, {dao_fuse_cache_loop_time, 1}],
    [{node_type, worker}, {dispatcher_port, 7777}, {control_panel_port, 1352}, {rest_port, 8445}, {ccm_nodes, [CCM]}, {dns_port, 1310}, {db_nodes, [DBNode]}, {fuse_session_expire_time, 2}, {dao_fuse_cache_loop_time, 1}],
    [{node_type, worker}, {dispatcher_port, 8888}, {control_panel_port, 1353}, {rest_port, 8446}, {ccm_nodes, [CCM]}, {dns_port, 1311}, {db_nodes, [DBNode]}, {fuse_session_expire_time, 2}, {dao_fuse_cache_loop_time, 1}]]),
