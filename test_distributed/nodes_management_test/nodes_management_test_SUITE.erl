...
callbacks_test(Config) ->
  ...
  Reg1 = #channelregistration{fuse_id = "fuse1"},
  ...
  Reg2 = #channelregistration{fuse_id = "fuse2"},
  ...
  UnReg = #channelclose{fuse_id = "fuse1"},
  ...
  CheckCallbacks = fun({Node, {FusesList, Fuse1AnsLength, Fuse2AnsLength}}, DispatcherCorrectAns) ->
    ...
    Test3 = gen_server:call({?Node_Manager_Name, Node}, {get_all_callbacks, "fuse1"}),
    ?assertEqual(Fuse1AnsLength, length(Test3)),
    Test4 = gen_server:call({?Node_Manager_Name, Node}, {get_all_callbacks, "fuse2"}),
    ?assertEqual(Fuse2AnsLength, length(Test4)),

    DispatcherCorrectAns
  end,

  DispatcherCorrectAns1 = {[{"fuse1", lists:reverse(NodesUp)}, {"fuse2", [CCM]}], 6},
  FuseInfo1 = [{["fuse1", "fuse2"], 2,1}, {["fuse1"], 1,0}, {["fuse1"], 1,0}, {["fuse1"], 1,0}],
  ...
  DispatcherCorrectAns2 = {[{"fuse1", [LastNode, CCM]}, {"fuse2", [CCM]}], 8},
  FuseInfo2 = [{["fuse1", "fuse2"], 1, 1}, {[], 0,0}, {[], 0,0}, {["fuse1"], 1,0}],
  ...
  CallbackSendTest1 = rpc:call(LastNode, request_dispatcher, send_to_fuse, ["fuse2", #atom{value = "test_atom"}, "communication_protocol"]),
  ...
  FuseMessage = #fusemessage{id = "fuse2", message_type = "testchannel", input = FslogicMessageMessageBytes},
