...
posix_write_dir_user_test(Config) ->
    ...
    ?assertMatch(ok, lfm_proxy:mv(W, SessId3, {guid, File2GUID}, <<"/space_name3/t7_dir/renamed_file">>)),
...
posix_write_dir_group_test(Config) ->
    ...
    ?assertMatch(ok, lfm_proxy:mv(W, SessId1, {guid, File2GUID}, <<"/space_name3/t8_dir/renamed_file">>)),
