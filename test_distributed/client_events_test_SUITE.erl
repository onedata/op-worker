...
init_per_testcase(events_on_conflicts_test, Config) ->
    ...
    test_utils:mock_new(Workers, file_meta_datastore_links),
    test_utils:mock_expect(Workers, file_meta_datastore_links, get_all, fun
...
end_per_testcase(events_on_conflicts_test, Config) ->
    Workers = ?config(op_worker_nodes, Config),
    test_utils:mock_validate_and_unload(Workers, file_meta_datastore_links),
