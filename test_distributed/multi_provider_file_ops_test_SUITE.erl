...
distributed_delete_test(Config) ->
    multi_provider_file_ops_test_base:distributed_delete_test_base(Config, <<"user1">>, {4, 2}, 60).

remote_driver_internal_call_test(Config0) ->
    User = <<"user1">>,
    Config = multi_provider_file_ops_test_base:extend_config(Config0, User, {4, 2}, 60),
...
remote_driver_test_base(Config, TestFun) ->
    Config2 = multi_provider_file_ops_test_base:extend_config(Config, <<"user1">>, {0, 0}, 0),
...
remove_file_during_transfers_test(Config0) ->
    % TODO VFS-6618 Fix handling of file being removed during transfer and uncomment this test
    User = <<"user2">>,
    Config = multi_provider_file_ops_test_base:extend_config(Config0, User, {0, 0}, 0),
...
dir_stats_collector_test(Config0) ->
    UserId = <<"user1">>,
    Config = multi_provider_file_ops_test_base:extend_config(Config0, UserId, {4, 2}, 60),
