...
import_file_with_link_but_no_doc_test(Config) ->
    storage_sync_s3_test_base:import_file_with_link_but_no_doc_test(Config, false).
...
sync_should_not_reimport_deleted_but_still_opened_file(Config) ->
    storage_sync_s3_test_base:sync_should_not_reimport_deleted_but_still_opened_file(Config).

sync_should_not_import_recreated_file_with_suffix_on_storage(Config) ->
    storage_sync_s3_test_base:sync_should_not_import_recreated_file_with_suffix_on_storage(Config).

sync_should_update_blocks_of_recreated_file_with_suffix_on_storage(Config) ->
    storage_sync_s3_test_base:sync_should_update_blocks_of_recreated_file_with_suffix_on_storage(Config).

sync_should_not_import_replicated_file_with_suffix_on_storage(Config) ->
    storage_sync_s3_test_base:sync_should_not_import_replicated_file_with_suffix_on_storage(Config).

sync_should_update_replicated_file_with_suffix_on_storage(Config) ->
    storage_sync_s3_test_base:sync_should_update_replicated_file_with_suffix_on_storage(Config).
...
should_not_sync_file_during_replication(Config) ->
    storage_sync_s3_test_base:should_not_sync_file_during_replication(Config).
...
create_file_import_race_test(Config) ->
    storage_sync_s3_test_base:create_file_import_race_test(Config).

close_file_import_race_test(Config) ->
    storage_sync_s3_test_base:close_file_import_race_test(Config).
