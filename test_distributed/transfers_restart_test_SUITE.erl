...
restart_test_base(Config, RestartFun, RestartType) ->
    ...
    % Create test files
    Files1 = file_ops_test_utils:create_files(WorkerP1, SessIdP1, SpaceDirGuid, FilesCount),
    Files2 = file_ops_test_utils:create_files(WorkerP1, SessIdP1, SpaceDirGuid, FilesCount),
