...
metadata(Config) ->
    ...
    Before = time_format:seconds_to_datetime(clock:timestamp_seconds()),
    {ok, Code1, _Headers1, Response1} = do_request(Workers, FileName, put, RequestHeaders1, RawRequestBody1),
    After = time_format:seconds_to_datetime(clock:timestamp_seconds()),
    ...
    CTime1 = time_format:iso8601_to_datetime(maps:get(<<"cdmi_ctime">>, Metadata1)),
    ATime1 = time_format:iso8601_to_datetime(maps:get(<<"cdmi_atime">>, Metadata1)),
    MTime1 = time_format:iso8601_to_datetime(maps:get(<<"cdmi_mtime">>, Metadata1)),
