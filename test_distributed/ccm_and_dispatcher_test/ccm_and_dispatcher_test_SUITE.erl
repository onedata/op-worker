...
init_per_testcase(type2, Config) ->
  ...
  Port = 6666,
  test_node_starter:start_app_on_nodes(?APP_Name, ?VEIL_DEPS, NodesUp, [[{node_type, ccm_test}, {dispatcher_port, Port}, {ccm_nodes, [CCM]}, {dns_port, 1315}, {db_nodes, [test_node_starter:get_db_node()]}, {heart_beat, 1},{nif_prefix, './'},{ca_dir, './cacerts/'}]]),
