...
replica_invalidate_should_migrate_unique_data(Config) ->
    ...
    % when
    ok = lfm_proxy:evict_file_replica(W1, SessionId, {guid, FileGuid}, LocalProviderId, ExternalProviderId),
    ...
    % when
    ok = lfm_proxy:evict_file_replica(W1, SessionId, {guid, FileGuid}, LocalProviderId, undefined),
...
dir_replica_invalidate_should_invalidate_all_children(Config) ->
    ...
    ok = lfm_proxy:evict_file_replica(W1, SessionId, {guid, DirGuid}, LocalProviderId, ExternalProviderId),
