...
db_sync_test(Config) ->
    ...
    multi_provider_file_ops_base:synchronization_test_base(Config, <<"user1">>, {4,2,0}, 150, 3, 10).
%%multi_provider_file_ops_base:synchronization_test_base(Config, <<"user1">>, {4,2,0}, 120, 3, 10).
...
file_consistency_test(Config) ->
    ...
    multi_provider_file_ops_base:file_consistency_test_base(Config, Worker1, Worker2, Worker3).
