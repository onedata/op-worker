                        ...
                        after_step_exp_state_diff = fun(#atm_mock_call_ctx{
                            ...
                            {true, case atm_workflow_execution_exp_state_builder:get_task_selector(AtmTaskExecutionId, ExpState1) of
                                {_, <<"pbox_first">>, _} ->
                                    ...
                                    atm_workflow_execution_exp_state_builder:expect_task_parallel_box_transit_to_inferred_status(
                ...
                #atm_lane_run_execution_test_spec{
                    ...
                    handle_task_execution_ended = #atm_step_mock_spec{
                        ...
                        after_step_exp_state_diff = fun(#atm_mock_call_ctx{
                            ...
                            {true, atm_workflow_execution_exp_state_builder:expect_task_parallel_box_transit_to_inferred_status(
                                AtmTaskExecutionId, InferStatusFun, ExpState1
                            )}
                        end
                    },
