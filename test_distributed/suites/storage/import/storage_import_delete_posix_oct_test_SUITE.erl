...
%%% directly on POSIX storage; see storage_import_delete_oct_test_base for the
%%% shared bodies.
%%% @end
%%%-------------------------------------------------------------------
-module(storage_import_delete_posix_oct_test_SUITE).
-author("Bartosz Walkowicz").
...
all() -> [
    ...
    bulk_deletion_test
    %% TODO VFS-13529 port the remaining group-A delete tests, then add here:
