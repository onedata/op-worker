...
delete_nested_archive_error(_Config) ->
    ...
    ?assertEqual(?ERR_NOT_FOUND, opt_archives:get_info(Node, SessionId, ArchiveId)),
    ?assertEqual(?ERR_NOT_FOUND, opt_archives:get_info(Node, SessionId, ParentArchiveId)).
