...
establish_dataset_attached_to_space_dir(_Config) ->
    ...
    ?assertDatasetMembership(P1Node, UserSessIdP1, SpaceGuid, ?DIRECT_INHERITANCE_PATH, ProtectionFlags),
...
establish_dataset_attached_to_dir(_Config) ->
    ...
    ?assertDatasetMembership(P1Node, UserSessIdP1, Guid, ?DIRECT_INHERITANCE_PATH, ProtectionFlags),
...
establish_dataset_attached_to_hardlink(_Config) ->
    ...
    ?assertDatasetMembership(P1Node, UserSessIdP1, LinkGuid, ?DIRECT_INHERITANCE_PATH, ProtectionFlags),
...
detach_and_reattach_dataset(_Config) ->
    ...
    ?assertDatasetMembership(P1Node, UserSessIdP1, Guid, ?NONE_INHERITANCE_PATH, ?no_flags_mask),
...
remove_attached_dataset(_Config) ->
    ...
    ?assertDatasetMembership(P1Node, User2SessIdP1, Guid, ?DIRECT_INHERITANCE_PATH, ProtectionFlags),
    ...
    ?assertDatasetMembership(P1Node, User2SessIdP1, Guid, ?NONE_INHERITANCE_PATH, ?no_flags_mask),
...
all_files_in_dataset_should_have_ancestor_dataset_membership(_Config) ->
    ...
    lists:foreach(fun(Guid) ->
        ?assertDatasetMembership(P1Node, UserSessIdP1, Guid, ?ANCESTOR_INHERITANCE, ProtectionFlags),
...
establish_nested_datasets_filetree_structure_with_hardlinks(_Config) ->
    ...
    ?assertFileEffDatasetSummaryAndMembership(P1Node, UserSessIdP1, FileGuid, FileDatasetId, [DirLvl4DatasetId, DirLvl3DatasetId, DirLvl2DatasetId], ?DIRECT_AND_ANCESTOR_INHERITANCE_PATH, ?ALL_PROTECTION),
    ...
    ?assertFileEffDatasetSummaryAndMembership(P1Node, UserSessIdP1, DirLvl4Guid, DirLvl4DatasetId, [DirLvl3DatasetId, DirLvl2DatasetId], ?DIRECT_AND_ANCESTOR_INHERITANCE_PATH, ?ALL_PROTECTION),

    ?assertAttachedDataset(P1Node, UserSessIdP1, DirLvl3DatasetId, DirLvl3Guid, DirLvl2DatasetId, ?ALL_PROTECTION, ?ALL_PROTECTION),
    ?assertFileEffDatasetSummaryAndMembership(P1Node, UserSessIdP1, DirLvl3Guid, DirLvl3DatasetId, [DirLvl2DatasetId], ?DIRECT_AND_ANCESTOR_INHERITANCE_PATH, ?ALL_PROTECTION),

    ?assertAttachedDataset(P1Node, UserSessIdP1, DirLvl2DatasetId, DirLvl2Guid, undefined, ?no_flags_mask, ?no_flags_mask),
    ?assertFileEffDatasetSummaryAndMembership(P1Node, UserSessIdP1, DirLvl2Guid, DirLvl2DatasetId, [], ?DIRECT_INHERITANCE_PATH, ?no_flags_mask),
    ...
    ?assertFileEffDatasetSummaryAndMembership(P1Node, UserSessIdP1, Link4Guid, Link4DatasetId, [DirLvl4DatasetId, DirLvl3DatasetId, DirLvl2DatasetId], ?DIRECT_AND_ANCESTOR_INHERITANCE_PATH, ?ALL_PROTECTION),

    ?assertAttachedDataset(P1Node, UserSessIdP1, Link3DatasetId, Link3Guid, DirLvl3DatasetId, ?ALL_PROTECTION, ?ALL_PROTECTION),
    ?assertFileEffDatasetSummaryAndMembership(P1Node, UserSessIdP1, Link3Guid, Link3DatasetId, [DirLvl3DatasetId, DirLvl2DatasetId], ?DIRECT_AND_ANCESTOR_INHERITANCE_PATH, ?ALL_PROTECTION),

    ?assertAttachedDataset(P1Node, UserSessIdP1, Link1DatasetId, Link1Guid, undefined, ?no_flags_mask, ?no_flags_mask),
    ?assertFileEffDatasetSummaryAndMembership(P1Node, UserSessIdP1, Link1Guid, Link1DatasetId, [], ?DIRECT_INHERITANCE_PATH, ?ALL_PROTECTION).
