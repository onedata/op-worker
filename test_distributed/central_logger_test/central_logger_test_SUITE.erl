...
init_per_testcase(logging_test, Config) ->
  ...
  StartLog = nodes_manager:start_app_on_nodes(Nodes, 
    [[{node_type, ccm}, 
      ...
      {ccm_nodes, [CCM]}, 
      {dns_port, 1308}, {control_panel_port, 2308}, {rest_port, 3308},
      {heart_beat, 1}],
    [{node_type, worker}, 
      {dispatcher_port, 5056}, 
      {ccm_nodes, [CCM]}, 
      {dns_port, 1309}, {control_panel_port, 2309}, {rest_port, 3309},
      {heart_beat, 1}],
    [{node_type, worker}, 
      {dispatcher_port, 5057}, 
      {ccm_nodes, [CCM]}, 
      {dns_port, 1310}, {control_panel_port, 2310}, {rest_port, 3310},
      {heart_beat, 1}],
    [{node_type, worker}, 
      {dispatcher_port, 5058}, 
      {ccm_nodes, [CCM]}, 
      {dns_port, 1311}, {control_panel_port, 2311}, {rest_port, 3311},
      {heart_beat, 1}],
    [{node_type, worker}, 
      {dispatcher_port, 5059}, 
      {ccm_nodes, [CCM]}, 
      {dns_port, 1312}, {control_panel_port, 2312}, {rest_port, 3312},
      {heart_beat, 1}]]),
