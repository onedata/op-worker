...
response_mocks() -> [
    ...
    #rest_mapping{port = 8080, path = <<"/test1/[:binding]">>, response = #rest_response{code = 206, content_type = <<"text/plain">>,
    ...
    #rest_mapping{port = 8080, path = <<"/test2">>, response = [
    ...
    #rest_mapping{port = 9090, path = <<"/test_with_state">>,
    ...
    #rest_mapping{port = 8080, path = <<"/test3">>, response = some_rubbish_that_will_cause_appmock_to_crash}
    ...
    #rest_mapping{port = 443, path = <<"/[:binding/[...]]">>,
