...
-define(CONFLIOCTING_STORAGE_FILE_SUFFIX_SEPARATOR, <<"%%%%">>).
-define(CONFLIOCTING_STORAGE_FILE_NAME(Filename,Uuid), <<Filename/binary,
    (?CONFLIOCTING_STORAGE_FILE_SUFFIX_SEPARATOR)/binary, Uuid/binary>>).

-define(IMPORTED_CONFLIOCTING_FILE_SUFFIX_SEPARATOR, <<"####IMPORTED###">>).
-define(IMPORTED_CONFLIOCTING_FILE_NAME(Name),
    <<(Name)/binary, (?IMPORTED_CONFLIOCTING_FILE_SUFFIX_SEPARATOR)/binary,
        (oneprovider:get_id())/binary>>).

-define(CONFLIOCTING_LOGICAL_FILE_SUFFIX_SEPARATOR, <<"@">>).
