...
-define(ATTR_WATCHERS_BY_OWNER_VIEW, #view_info{name = "attr_watchers_by_owner", db_name = ?DESCRIPTORS_DB_NAME, version = 1}).
...
-define(VIEW_LIST, [?FILE_TREE_VIEW, ?WAITING_FILES_TREE_VIEW, ?FILE_CHILDS_VIEW, ?FD_BY_FILE_VIEW, ?FD_BY_EXPIRED_BEFORE_VIEW, ?ALL_STORAGE_VIEW,
    ...
    ?AVAILABLE_BLOCKS_BY_FILE_ID, ?ATTR_WATCHERS_BY_EXPIRED_BEFORE_VIEW, ?ATTR_WATCHERS_BY_NAME_VIEW, ?ATTR_WATCHERS_BY_OWNER_VIEW]).
