...
-record(cm_state, {nodes = [], workers = [], dispatcher_maps = [], state_num = 1, callbacks_num = 1, cluster_check_num = 0, state_loaded = false, state_monitoring = on, storage_stats = #storage_stats{}}).
