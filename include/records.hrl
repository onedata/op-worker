...
-record(node_state, {node_type = worker, ccm_con_status = not_connected, state_num = 0, callbacks_num = 0, dispatcher_state = 0, callbacks_state = 0, callbacks = [], simple_caches = [], load_logging_fd = undefined}).
...
-record(cm_state, {nodes = [], workers = [], dispatcher_maps = [], state_num = 1, callbacks_num = 1, cluster_check_num = 0, state_loaded = false, state_monitoring = on}).
