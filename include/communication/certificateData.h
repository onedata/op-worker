...
public:
    ...
    virtual std::shared_ptr<boost::asio::ssl::context> initContext(
            std::shared_ptr<boost::asio::ssl::context> ctx) const = 0;
...
public:
     ...
     * @return @p ctx.
     */
    std::shared_ptr<boost::asio::ssl::context> initContext(
            std::shared_ptr<boost::asio::ssl::context> ctx) const override;
