...
==========
	...
	:Descritpion: This module implements rest_module_behaviour and handles all REST requests directed at /rest/attrs/(path). It returns file attributes, if possible.
