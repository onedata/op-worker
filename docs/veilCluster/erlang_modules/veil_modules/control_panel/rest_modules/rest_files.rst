...
==========
	...
	:Descritpion: This module implements rest_module_behaviour and handles all REST requests directed at /rest/file/*. Essentially, it serves user content (files) via HTTP.
...
~~~~~~~~~~~~~~~~~
	...
	.. erl:function:: handle_multipart_data(req(), binary(), binary(), term()) -> {boolean(), req()}
