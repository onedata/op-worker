...
~~~~~~~~~~~~~~~~~
	...
	.. erl:module:: fslogic_utils

	.. _`fslogic_utils;basename/1`:

	.. erl:function:: basename(Path :: string()) -> string()

	Gives file basename from given path

	.. _`fslogic_utils;create_children_list/1`:

	.. erl:function:: create_children_list(Files :: list()) -> Result
	...
	* **Result:** term()
	...
	.. erl:function:: create_children_list(Files :: list(), TmpAns :: list()) -> Result
	...
	* **Result:** term()
	...
	.. erl:function:: get_parent_and_name_from_path(Path :: string(), ProtocolVersion :: term()) -> Result
	...
	* **Result:** tuple()
	...
	.. erl:function:: strip_path_leaf(Path :: string()) -> string()

	Strips file name from path

	.. _`fslogic_utils;time/0`:

	.. erl:function:: time() -> Result :: integer()

	Returns time in seconds.

	.. _`fslogic_utils;update_meta_attr/3`:

	.. erl:function:: update_meta_attr(File :: #file{}, Attr, Value :: term()) -> Result :: #file{}
