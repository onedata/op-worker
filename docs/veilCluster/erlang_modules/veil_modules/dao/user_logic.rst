...
~~~~~~~~~~~~~~~~~
	...
	.. erl:module:: user_logic

	.. _`user_logic;create_dirs_at_storage/2`:

	.. erl:function:: create_dirs_at_storage(Root :: string(), Teams :: [string()]) -> ok | Error
	...
	* **Error:** atom()
	...
	.. erl:function:: create_user(Login, Name, Teams, Email, DnList) -> Result
	...
	* **Teams:** string()
	...
	.. erl:function:: extract_dn_from_cert(PemBin :: binary()) -> {rdnSequence, [#'AttributeTypeAndValue'{}]} | {error, Reason}
	...
	* **Reason:** proxy_ceertificate | self_signed | extraction_failed
	...
	.. erl:function:: get_dn_list(User) -> Result
	...
	* **User:** user_doc()
	...
	.. erl:function:: get_email_list(User) -> Result
	...
	* **User:** user_doc()
	...
	.. erl:function:: get_login(User) -> Result
	...
	* **User:** user_doc()
	...
	.. erl:function:: get_name(User) -> Result
	...
	* **User:** user_doc()
	...
	.. erl:function:: get_team_names(UserQuery :: term()) -> [string()] | no_return()
	...
	.. erl:function:: get_teams(User) -> Result
	...
	* **User:** user_doc()
	...
	.. erl:function:: get_user(Key :: {login, Login :: string()} | {email, Email :: string()} | {uuid, UUID :: user()} | {dn, DN :: string()} | {rdnSequence, [#'AttributeTypeAndValue'{}]}) -> {ok, user_doc()} | {error, any()}
	...
	.. erl:function:: invert_dn_string(string()) -> string()

	Inverts the sequence of entries in a DN string.

	.. _`user_logic;oid_code_to_shortname/1`:

	.. erl:function:: oid_code_to_shortname(term()) -> string() | no_return()

	Converts erlang-like OID code to OpenSSL short name.

	.. _`user_logic;rdn_sequence_to_dn_string/1`:

	.. erl:function:: rdn_sequence_to_dn_string([#'AttributeTypeAndValue'{}]) -> string() | no_return()

	Converts rdnSequence to DN string so that it can be compared to another DN.

	.. _`user_logic;remove_user/1`:

	.. erl:function:: remove_user(Key :: {login, Login :: string()} | {email, Email :: string()} | {uuid, UUID :: user()} | {dn, DN :: string()} | {rdnSequence, [#'AttributeTypeAndValue'{}]}) -> Result :: ok | {error, any()}

	 Removes user from DB by login.

	.. _`user_logic;shortname_to_oid_code/1`:

	.. erl:function:: shortname_to_oid_code(string()) -> term() | no_return()

	Converts OpenSSL short name to erlang-like OID code.

	.. _`user_logic;sign_in/1`:

	.. erl:function:: sign_in(Proplist) -> Result
	...
	* **Result:** {string(), user_doc()}
	...
	.. erl:function:: update_dn_list(User, NewDnList) -> Result
	...
	* **User:** user_doc()
	...
	.. erl:function:: update_email_list(User, NewEmailList) -> Result
	...
	* **User:** user_doc()
	...
	.. erl:function:: update_teams(User, NewTeams) -> Result
