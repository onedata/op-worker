...
~~~~~~~~~~~~~~~~~
	...
	.. erl:function:: apply(Module :: module(), Method :: atom() | {synch, atom()} | {asynch, atom()}, Args :: [term()], ProtocolVersion :: number()) -> any() | {error, worker_not_found}

	Same as apply/5 but with default Timeout

	.. _`dao_lib;apply/5`:

	.. erl:function:: apply(Module :: module(), Method :: atom() | {synch, atom()} | {asynch, atom()}, Args :: [term()], ProtocolVersion :: number(), Timeout :: pos_integer()) -> any() | {error, worker_not_found} | {error, timeout}
	...
	.. erl:function:: strip_wrappers(VeilDocOrList :: #veil_document{} | [#veil_document{}]) -> tuple() | [tuple()]
	...
	.. erl:function:: wrap_record(Record :: tuple()) -> #veil_document{}
