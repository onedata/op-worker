...
~~~~~~~~~~~~~~~~~
	...
	.. erl:module:: dao_helper

	.. _`dao_helper;create_db/1`:

	.. erl:function:: create_db(DbName :: string()) -> ok | {error, term()}

	Creates db named DbName. If db already does nothing and returns 'ok'

	.. _`dao_helper;create_db/2`:

	.. erl:function:: create_db(DbName :: string(), Opts :: [Option]) -> ok | {error, term()}
	...
	* **Option:** atom() | {atom(), term()}
	...
	.. erl:function:: create_view(DbName :: string(), DesignName :: string(), ViewName :: string(), Map :: string(), Reduce :: string(), DesignVersion :: integer()) -> [ok | {error, term()}]

	Creates view with given Map and Reduce function. When Reduce = "", reduce function won't be created

	.. _`dao_helper;delete_db/1`:

	.. erl:function:: delete_db(DbName :: string()) -> ok | {error, database_does_not_exist} | {error, term()}

	Deletes db named DbName

	.. _`dao_helper;delete_db/2`:

	.. erl:function:: delete_db(DbName :: string(), Opts :: [Option]) -> ok | {error, database_does_not_exist} | {error, term()}
	...
	* **Option:** atom() | {atom(), term()}
	...
	.. erl:function:: delete_doc(DbName :: string(), DocID :: string()) -> ok | {error, missing} | {error, deleted} | {error, term()}

	Deletes doc from db

	.. _`dao_helper;delete_docs/2`:

	.. erl:function:: delete_docs(DbName :: string(), [DocID :: string()]) -> [ok | {error, term()}]

	Deletes list of docs from db

	.. _`dao_helper;gen_uuid/0`:

	.. erl:function:: gen_uuid() -> string()

	Generates UUID with CouchDBs 'utc_random' algorithm

	.. _`dao_helper;get_db_info/1`:

	.. erl:function:: get_db_info(DbName :: string()) -> {ok, [ {instance_start_time, binary()} | {doc_count, non_neg_integer()} | {doc_del_count, non_neg_integer()} | {purge_seq, non_neg_integer()} | {compact_running, boolean()} | {disk_size, non_neg_integer()} | {disk_format_version, pos_integer()} ]} | {error, database_does_not_exist} | {error, term()}

	Returns db info for the given DbName

	.. _`dao_helper;get_doc_count/1`:

	.. erl:function:: get_doc_count(DbName :: string()) -> {ok, non_neg_integer()} | {error, database_does_not_exist} | {error, term()}

	Returns doc count for given DbName

	.. _`dao_helper;insert_doc/2`:

	.. erl:function:: insert_doc(DbName :: string(), Doc :: #doc{}) -> {ok, {RevNum :: non_neg_integer(), RevBin :: binary()}} | {error, conflict} | {error, term()}

	Inserts doc to db

	.. _`dao_helper;insert_doc/3`:

	.. erl:function:: insert_doc(DbName :: string(), Doc :: #doc{}, Opts :: [Option]) -> {ok, {RevNum :: non_neg_integer(), RevBin :: binary()}} | {error, conflict} | {error, term()}
	...
	* **Option:** atom() | {atom(), term()}
	...
	.. erl:function:: insert_docs(DbName :: string(), [Doc :: #doc{}]) -> {ok, term()} | {error, term()}

	Inserts list of docs to db

	.. _`dao_helper;insert_docs/3`:

	.. erl:function:: insert_docs(DbName :: string(), [Doc :: #doc{}], Opts :: [Option]) -> {ok, term()} | {error, term()}
	...
	* **Option:** atom() | {atom(), term()}
	...
	.. erl:function:: list_dbs() -> {ok, [string()]} | {error, term()}

	Lists all dbs

	.. _`dao_helper;list_dbs/1`:

	.. erl:function:: list_dbs(Prefix :: string()) -> {ok, [string()]} | {error, term()}

	Lists all dbs that starts with Prefix

	.. _`dao_helper;name/1`:

	.. erl:function:: name(Name :: string() | atom()) -> binary()

	Converts string/atom to binary

	.. _`dao_helper;open_design_doc/2`:

	.. erl:function:: open_design_doc(DbName :: string(), DesignName :: string()) -> {ok, #doc{}} | {error, {not_found, missing | deleted}} | {error, term()}

	Returns design document with a given design doc name

	.. _`dao_helper;open_doc/2`:

	.. erl:function:: open_doc(DbName :: string(), DocID :: string()) -> {ok, #doc{}} | {error, {not_found, missing | deleted}} | {error, term()}

	Returns document with a given DocID

	.. _`dao_helper;open_doc/3`:

	.. erl:function:: open_doc(DbName :: string(), DocID :: string(), Opts :: [Option]) -> {ok, #doc{}} | {error, {not_found, missing | deleted}} | {error, term()}
	...
	* **Option:** atom() | {atom(), term()}
	...
	.. erl:function:: query_view(DbName :: string(), DesignName :: string(), ViewName :: string()) -> {ok, QueryResult :: term()} | {error, term()}

	Execute a given view with default set of arguments. Check record #view_query_args for details.

	.. _`dao_helper;query_view/4`:

	.. erl:function:: query_view(DbName :: string(), DesignName :: string(), ViewName :: string(), QueryArgs :: #view_query_args{}) -> {ok, QueryResult :: term()} | {error, term()}
	...
	.. erl:function:: revision(RevInfo :: term()) -> term()
