...
~~~~~~~~~~~~~~~~~
	...
	.. erl:module:: dao_share

	.. _`dao_share;get_file_share/1`:

	.. erl:function:: get_file_share(Key:: {file, File :: uuid()} | {user, User :: uuid()} | {uuid, UUID :: uuid()}) -> {ok, file_share_doc()} | {ok, [file_share_doc()]} | {error, any()} | no_return()
	...
	.. erl:function:: remove_file_share(Key:: {file, File :: uuid()} | {user, User :: uuid()} | {uuid, UUID :: uuid()}) -> {error, any()} | no_return()
	...
	.. erl:function:: save_file_share(Share :: file_share_info() | file_share_doc()) -> {ok, file_share()} | {error, any()} | no_return()
