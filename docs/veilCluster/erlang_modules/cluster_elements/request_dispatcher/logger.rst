...
~~~~~~~~~~~~~~~~~
	...
	.. erl:function:: dispatch_log(LoglevelAsInt :: integer(), Metadata :: [tuple()], Format :: string(), Args :: string(), IncludeStacktrace :: boolean()) -> ok | {error, lager_not_running}
	...
	.. erl:function:: loglevel_int_to_atom(LoglevelAsInt :: integer()) -> atom()
	...
	.. erl:function:: parse_process_info(ProcessInfo :: tuple()) -> [tuple()]

	Changes standard 'process_info' tuple into metadata proplist

	.. _`logger;set_console_loglevel/1`:

	.. erl:function:: set_console_loglevel(Loglevel :: integer() | atom()) -> ok | {error, badarg}
	...
	.. erl:function:: set_include_stacktrace(boolean()) -> ok | {error, badarg}

	Changes include_stacktrace env to true or false

	.. _`logger;set_loglevel/1`:

	.. erl:function:: set_loglevel(Loglevel :: integer() | atom()) -> ok | {error, badarg}
	...
	.. erl:function:: should_log(LoglevelAsInt :: integer()) -> boolean()
