...
~~~~~~~~~~~~~~~~~
	...
	.. erl:module:: gsi_handler

	.. _`gsi_handler;call/3`:

	.. erl:function:: call(Module :: atom(), Method :: atom(), Args :: [term()]) -> ok | no_return()
	...
	.. erl:function:: find_eec_cert(CurrentOtp :: #'OTPCertificate'{}, Chain :: [#'OTPCertificate'{}], IsProxy :: boolean()) -> {ok, #'OTPCertificate'{}} | no_return()

	For given proxy certificate returns its EEC

	.. _`gsi_handler;init/0`:

	.. erl:function:: init() -> ok
	...
	.. erl:function:: is_proxy_certificate(OtpCert :: #'OTPCertificate'{}) -> boolean()

	Checks is given OTP Certificate has an proxy extension

	.. _`gsi_handler;load_certs/1`:

	.. erl:function:: load_certs(CADir :: string()) -> ok | no_return()
	...
	.. erl:function:: proxy_subject(OtpCert :: #'OTPCertificate'{}) -> {rdnSequence, [#'AttributeTypeAndValue'{}]}

	Returns subject of given certificate. If proxy certificate is given, EEC subject is returned.

	.. _`gsi_handler;update_crls/1`:

	.. erl:function:: update_crls(CADir :: string()) -> ok | no_return()
	...
	.. erl:function:: verify_callback(OtpCert :: #'OTPCertificate'{}, Status :: term(), Certs :: [#'OTPCertificate'{}]) -> {valid, UserState :: any()} | {fail, Reason :: term()}
