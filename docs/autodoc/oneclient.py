...
class oneclient(Sphinx):
	...
	def autodoc(self):
		...
		self.index = minidom.parse(self.root + '/oneclient/doc/xml/index.xml').getElementsByTagName('compound')
...
if __name__ == '__main__':
	...
	if len(sys.argv) != 3:
		...
		print "Usage: python {0} path_to_root_folder path_to_oneclient_folder".format(sys.argv[0])
		exit(1)

	oneclient = oneclient(sys.argv[1], sys.argv[2])
	oneclient.autodoc()
