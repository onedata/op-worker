...
if __name__ == '__main__':
	...
	if len(sys.argv) != 3:
		...
		print "Usage: python {0} path_to_root_folder path_to_oneprovider_folder".format(sys.argv[0])
		exit(1)

	oneprovider = oneprovider(sys.argv[1], sys.argv[2])
	oneprovider.autodoc()
